      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-6 bg-cyber-background">
          <div className="max-w-5xl mx-auto space-y-8">
            {/* About the Platform */}
            <Card className="border-cyber-primary/20 bg-white/90 backdrop-blur-md shadow-lg">
              <CardHeader>
                <CardTitle className="text-3xl font-bold gradient-text">About the Cyber Crime Monitoring Platform</CardTitle>
                <CardDescription>
            ...
            <Card className="border-cyber-primary/20 bg-white/90 backdrop-blur-md shadow-lg">
              <CardHeader>
                <CardTitle className="text-3xl font-bold gradient-text">About the Developer</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <div className="flex flex-col md:flex-row items-center gap-6">
                  ...
                  <div className="space-y-3 text-center md:text-left">
                    <h3 className="text-2xl font-semibold">Rahul Kumar Sharma</h3>
                ...
                <div className="pt-4 border-t border-gray-200">
                  <h3 className="text-xl font-semibold mb-3">About Rahul</h3>
                  <p className="mb-4">
